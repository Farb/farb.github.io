...
```sh
PS D:\code\blogs\farb.github.io> docker pull images
...
# 配置主从关系，这里注意`change master to`已经在MySql8.4中被`CHANGE REPLICATION SOURCE TO`取代
...
# 查看主从复制状态，看到Replica_IO_Running: Yes 和 Replica_SQL_Running: Yes，说明配置主从复制成功
